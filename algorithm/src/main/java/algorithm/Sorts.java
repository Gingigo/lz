...
public class Sorts {
    public static void main(String[] args) {
        int[] array = {1, 5, 2, 3, 8, 8, 0, 0};
        int[] ans = new Sorts().mergeSort(array);
...
//            array[right] = temp1;
    ...
    /**
     * @description 创建最小堆
     * 从 index【1】插入，新插入的index【n】和index【n/2】对比,在看是否交换
    ...
    /**
     * @description 拿到最小数
     * 获取index【1】,然后将末尾的数放到index【1】,在和子节点比较，看是否要交换
